...
//==============================================================================
TripleDistAudioProcessorEditor::TripleDistAudioProcessorEditor (TripleDistAudioProcessor& p)
...
;
TripleDistAudioProcessorEditor::~TripleDistAudioProcessorEditor()
{
}

//==============================================================================
void TripleDistAudioProcessorEditor::paint (juce::Graphics& g)
{
    float border = 0.05 ;
    ...
    g.setFont(16);
    g.drawSingleLineText("fxmechanics.com",
                          unitXBorder+3.9*unitX,
...
void TripleDistAudioProcessorEditor::resized()
{
