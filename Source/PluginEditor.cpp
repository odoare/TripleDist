    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    freqSlider.setLookAndFeel(&myLookAndFeel);
    ...
    qSlider.setLookAndFeel(&myLookAndFeel);
    ...
    bandGainSlider.setLookAndFeel(&myLookAndFeel);
    ...
    lowLevelSlider.setLookAndFeel(&myLookAndFeel);
    ...
    bandLevelSlider.setLookAndFeel(&myLookAndFeel);
    ...
    highLevelSlider.setLookAndFeel(&myLookAndFeel);
    ...
    lowPanSlider.setLookAndFeel(&myLookAndFeel);
    ...
    bandPanSlider.setLookAndFeel(&myLookAndFeel);
    ...
    highPanSlider.setLookAndFeel(&myLookAndFeel);
